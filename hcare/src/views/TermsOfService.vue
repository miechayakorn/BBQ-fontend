<template>
  <div class="container fixed-container text-left">
    <h1>Privacy Policy</h1>
    <p>Last updated: October 30, 2020</p>
    <p>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Hcare.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Hcare, accessible from
          <a href="https://hcare-kmutt.web.app" target="_blank"
            >https://hcare-kmutt.web.app</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      ...
      <li>
        ...
        <a
          ...
          target="_blank"
          >https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html</a
        >
      </li>
      <li>
    ...
    <ul>
      <li>By phone number: 02-4708446</li>
    </ul>
  </div>
</template>
